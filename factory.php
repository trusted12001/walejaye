...
<body>
    ...
    <div class="banner-area fix">
        <?php include('assets/includes/banners.php'); ?>
    </div>
    <!-- banner area  end-->
	...
	<div class="about-main-area">
        <?php include('assets/includes/welcome.php'); ?>
    </div>
    <!-- welcome area  end-->
    ...
    <div class="new-arrivals-area bg-img-1">
        <?php include('assets/includes/we_clean.php'); ?>
    </div>
    <!-- We clean area end -->
    ...
    <div class="product-area bg-1 ptb-100">
        <?php include('assets/includes/properties.php'); ?>
    </div>
    <!-- properties area end -->


    <!-- testmonial and news letter area start -->
    <div class="testimonial-main-area">
        <?php include('assets/includes/testimony_news_letter.php'); ?>
    </div>
    <!-- testmonial and news letter area end -->


    <!-- testmonial and news letter area start -->
    <div class="about-main-area">
        <?php include('assets/includes/about_page.php'); ?>
    </div>
    <!-- testmonial and news letter area end -->


    <!-- Cleaning Services area start -->
    <div class="about-main-area">
        <?php include('assets/includes/cleaning_services_page.php'); ?>
    </div>
    <!-- Cleaning Services area end -->


    <!-- Tech Services area start -->
    <div class="about-main-area">
        <?php include('assets/includes/tech_services_page.php'); ?>
    </div>
    <!-- Tech Services area end -->


    <!-- Real Estate area start -->
    <div class="about-main-area">
        <?php include('assets/includes/estate_services_page.php'); ?>
    </div>
